...
const StashedRequest = (0, import_valibot.object)({
  id: (0, import_valibot.string)("`id` is required", [(0, import_valibot.uuid)()]),
  origin: (0, import_valibot.string)([(0, import_valibot.url)("`origin` must be a valid URL")]),
...
const StashedResponse = (0, import_valibot.object)({
  id: (0, import_valibot.string)([(0, import_valibot.uuid)()]),
  source: (0, import_valibot.literal)("zksend-channel"),
